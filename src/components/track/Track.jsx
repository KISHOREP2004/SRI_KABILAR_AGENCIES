                    ...
                    <div className="flex flex-wrap -m-4 text-center">
                        ...
                        <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                            <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-200 bg-gray-100 shadow-[inset_0_0_2px_rgba(0,0,0,0.6)] px-4 py-6 rounded-lg" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                ...
                                <h2 className="title-font font-medium text-lg text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Premium Top Brand Products</h2>
                                <p className="leading-relaxed">Discover top-quality hardware and paints online at [Sri Kabilar Agencies]. From tools to coatings, we've got all your project needs covered. Shop now and unleash your creativity!
                                </p>
                            </div>
                        </div>
